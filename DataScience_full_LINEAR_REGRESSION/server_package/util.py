...
def show_estimated_price(location, sqft, bath, room_size):
    try:
...
if __name__ == "__main__":
    load_server_effects()
    print(show_estimated_price("1st block jayanagar", 1000, 3, 3))
    print(show_estimated_price("1st phase jp nagar", 1000, 2, 2))
    print(show_estimated_price("2nd phase judicial layout", 1000, 2, 2))  # other location
    print(show_estimated_price("2nd stage nagarbhavi", 1000, 3, 3))  # other location
